...
| **Latest commit (main)** | PR #50 in flight — `feat(time-clock): persist Clock In/Out + 'On the Clock' Hub widget`. PRs #58 (Members left-rail) + #60 (remove subtitles) + #59 (Assign alignment) merged just prior. |
