...
| **Latest commit (main)** | PR #59 in flight — `fix(assign): align right-pane top edge with sidebar by folding toolbar into main card`. PR #58 (Members left-rail restructure) also open in parallel. |
