-- Admin fallback for profile-only members whose Supabase Auth account
-- cannot be provisioned through GoTrue's email-check path.
--
-- This is intentionally narrow:
--   - caller must be a signed-in team admin
--   - target must be in the caller's team
--   - primary owner is excluded
--   - password is marked temporary via requires_password_change
