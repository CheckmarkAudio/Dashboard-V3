-- PR #38 — surface `task_reassign_request_id` in the notifications
-- RPC so the frontend click-handler can branch on it and open the
-- reassign Approve/Decline modal.
  ...
  RETURN COALESCE((
    SELECT jsonb_agg(
      jsonb_build_object(
        ...
        'task_reassign_request_id',   n.task_reassign_request_id,
