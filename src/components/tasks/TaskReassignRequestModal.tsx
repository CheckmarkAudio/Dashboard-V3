      ...
      {!declineOpen ? (
        <div className="mt-3 flex items-center gap-2">
          <button
            ...
            onClick={onApprove}
            disabled={isBusy}
            className="flex-1 inline-flex items-center justify-center gap-1.5 py-1.5 rounded-lg text-[12px] font-bold bg-gold text-black hover:bg-gold-muted disabled:opacity-50"
          >
