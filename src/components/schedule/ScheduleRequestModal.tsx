      ...
      <div className="relative w-full max-w-md bg-surface rounded-2xl border border-border shadow-2xl p-5 animate-fade-in">
        ...
        <div className="grid gap-2 mb-4">
          ...
          <ScheduleChoice
            ...
            description="Vacation or unavailable dates. Data model approval is next."
            badge="Next"
  ...
  return (
    <div className="space-y-3">
      <div className="rounded-xl border border-amber-400/25 bg-amber-400/8 p-3">
        <p className="text-[13px] font-bold text-text">Time off is the next backend pass.</p>
        <p className="mt-1 text-[11px] leading-relaxed text-text-muted">
          We are showing this choice now so workers understand where vacation and unavailable days will live.
          We are not saving it as work time until the time-off data contract is approved.
        </p>
      </div>
