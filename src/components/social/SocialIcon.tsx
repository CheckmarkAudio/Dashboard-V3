...
function FacebookGlyph({ size = 20 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path d="M15.12 8.2h2.33l.37-2.85c-.64-.09-1.85-.2-3.08-.2-3.05 0-5.15 1.86-5.15 5.24v1.65H6.63v3.3h2.96V24h3.56v-8.66h3.02l.57-3.3h-3.59v-1.32c0-1.76.5-2.52 1.97-2.52z" />
    </svg>
  )
}
...
function TikTokGlyph({ size = 20 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
...
export function SocialIconTile({
  platform,
  size = 40,
  iconSize = 21,
  className = '',
  ...
  return (
    <span
      className={`inline-flex items-center justify-center rounded-full bg-[#251c1b] text-white shadow-[0_6px_14px_rgba(37,28,27,0.18)] transition-colors group-hover:bg-gold group-hover:text-black ${className}`}
