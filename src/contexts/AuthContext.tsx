...
export function AuthProvider({ children }: { children: ReactNode }) {
  // Local-dev mock — `import.meta.env.DEV` is build-time true ONLY when
  // running `vite dev`. Vercel builds (preview AND production) get
  // `DEV=false`, so this can never mount on a deployed site.
